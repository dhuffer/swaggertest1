# swaggertest1 OpenAPI Specification
[![Build Status](https://travis-ci.org/dhuffer/swaggertest1.svg?branch=master)](https://travis-ci.org/dhuffer/swaggertest1)
...
6. If you did everything correct, https://dhuffer.github.io/swaggertest1/ will lead to your new docs
...
- Documentation(ReDoc): https://dhuffer.github.io/swaggertest1/
- SwaggerUI: https://dhuffer.github.io/swaggertest1/swagger-ui/
- Look full spec:
    + JSON https://dhuffer.github.io/swaggertest1/swagger.json
    + YAML https://dhuffer.github.io/swaggertest1/swagger.yaml
- Preview spec version for branch `[branch]`: https://dhuffer.github.io/swaggertest1/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://dhuffer.github.io/swaggertest1/ with url from the message: `Server started <url>`
